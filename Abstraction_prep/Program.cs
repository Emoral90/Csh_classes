...
public class Program{
    ...
    static void Main(){
        ...
        // Assign variables to myResume attributes
        myResume.name = "Erick Morales";
        myResume.jobs.Add("CNS Student Assistant");
        myResume.jobs.Add("Jonda Tenchician");
        myResume.jobs.Add("Bony Audio Sales Representative");

        // Call the myResume display method 
        myResume.display_resume();
    }
